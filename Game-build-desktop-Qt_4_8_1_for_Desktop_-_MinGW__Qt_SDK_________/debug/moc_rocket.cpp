...
**
** Created: Mon 3. Mar 07:37:20 2014
...
static const char qt_meta_stringdata_Rocket[] = {
    "Rocket\0"
};
...
const QMetaObjectExtraData Rocket::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Rocket::staticMetaObject = {
    { &Bullet::staticMetaObject, qt_meta_stringdata_Rocket,
      qt_meta_data_Rocket, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Rocket::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Rocket))
